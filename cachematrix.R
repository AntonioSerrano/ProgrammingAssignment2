...
## This first function, called makeCacheMatrix, creates a special "matrix", which
...
## This second function (cachesolve) calculates the inverse of the special "martrix"
